...
def setting_markup(_):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(text=_["ST_B_2"], callback_data="PM", style=alone_style),
        ],
        [
            InlineKeyboardButton(text=_["ST_B_4"], callback_data="VM", style=alone_style),
        ],
        [
...
def vote_mode_markup(_, current, mode: Union[bool, str] = None):
    ...
    buttons = [
        [
            InlineKeyboardButton(text="Vᴏᴛɪɴɢ ᴍᴏᴅᴇ ➜", callback_data="VOTEANSWER", style=group_style),
...
def auth_users_markup(_, status: Union[bool, str] = None):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(text=_["ST_B_1"], callback_data="AUTHLIST", style=alone_style),
        ],
        [
            InlineKeyboardButton(
                text=_["BACK_BUTTON"],
